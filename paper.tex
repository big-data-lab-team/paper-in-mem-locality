...
\begin{tabular}{c|ccc|cccc|cc}
 ...
 \hline
1   &75    & 430    & 178.6 & 9 & 21.5 & 125 & 4.0 & \cellcolor{red!20} No & \cellcolor{red!20} No\\
10  & 750   & 4,300 & 178.6 & 9 & 21.5 & 125 & 4.0 & \cellcolor{red!20} No & \cellcolor{red!20} No\\
100 & 7,500 & 43,000& 178.6 & 9 & 21.5 & 125 & 4.0 & \cellcolor{red!20} No & \cellcolor{red!20} No\\
\hline
  \multicolumn{10}{c}{}\\
...
\rowcolor{headcolor}
 ...
 \parbox{2cm}{Page-cache on local disk? (Eq.~\ref{eq:page-cache-inequality})} & \parbox{2cm}{Page cache on Lustre? (Eq.~\ref{eq:page-cache-sharedfs})}\\
 \hline
 2.4  & 750 & 3,000   & 256   & 9 & 21.5 & 125 & 4.0 &  \cellcolor{red!20} No & \cellcolor{red!20} No   \\
 3.44 & 750 & 4,300   & 178.6 & 9 & 21.5 & 125 & 4.0 &  \cellcolor{red!20} No & \cellcolor{red!20} No   \\
 7.68 & 750 & 9,600   & 80    & 9 & 21.5 & 125 & 4.0 &  \cellcolor{red!20} No & \cellcolor{red!20} No   \\
 320  & 750 & 400,000 & 1.9   & 9 & 21.5 & 125 & 4.0 &  \cellcolor{green!20} Yes & \cellcolor{green!20} Yes  \\
 \hline
  \multicolumn{10}{c}{}\\
 ...
 \parbox{2cm}{Page-cache on local disk? (Eq.~\ref{eq:page-cache-inequality})} & \parbox{2cm}{Page cache on Lustre? (Eq.~\ref{eq:page-cache-sharedfs})}\\
 \hline
 30  & 750 & 4,400   & 174.6 & 2  & 96.8 & 30  & 16.8 &  \cellcolor{red!20} No & \cellcolor{red!20} No   \\
 125 & 750 & 4,400   & 174.6 & 9  & 21.5 & 125 & 4.0 &  \cellcolor{red!20} No & \cellcolor{red!20} No   \\
 750 & 750 & 4,400   & 174.6 & 25 & 7.7  & 375 & 1.3 &  \cellcolor{red!20} No & \cellcolor{red!20} No  \\
...
\hline
 ...
 \parbox{2cm}{Page-cache on local disk? (Eq.~\ref{eq:page-cache-inequality})} & \parbox{2cm}{Page cache on Lustre? (Eq.~\ref{eq:page-cache-sharedfs})}\\
 \hline
 BigBrain      & 750   & 2,200   & 349.1     & 9  & 21.5  & 125 & 4.0 &  \cellcolor{red!20} No & \cellcolor{red!20} No   \\
 Half BigBrain & 375   & 2,200   & 174.6     & 9  & 21.5  & 125 & 4.0 &  \cellcolor{red!20} No & \cellcolor{red!20} No   \\
 MRI           & 0.127 & 2,200   & 0.06 & 9& 21.5  & 125 & 4.0 &  \cellcolor{green!20} Yes & \cellcolor{green!20} Yes  
\end{tabular}
...
($\delta$/$\gamma$) and (D/C) / 
($\Delta$/$\Gamma$) ratios (Fig.~\ref{fig:modeleval}). Experiments for 
which there was no in-memory equivalent (i.e. BigBrain split into 30 
chunks) 
were not considered.
