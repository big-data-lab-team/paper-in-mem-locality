...
\begin{abstract}
We benchmark in-memory, computing, data locality and lazy Big Data processing 
strategies on typical neuroimaging processing use cases represented by the BigBrain dataset. We use Dell 
...
when necessary to enable further performance optimizations. Frameworks 
such as
